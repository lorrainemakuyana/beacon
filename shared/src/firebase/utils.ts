...
export const getUsersCollection = () => collection(firestore, COLLECTIONS.USERS);
export const getOrganizationsCollection = () => collection(firestore, COLLECTIONS.ORGANIZATIONS);
export const getEventsCollection = () => collection(firestore, COLLECTIONS.EVENTS);
export const getAttendanceCollection = () => collection(firestore, COLLECTIONS.ATTENDANCE);
export const getIncidentsCollection = () => collection(firestore, COLLECTIONS.INCIDENTS);
export const getNotificationsCollection = () => collection(firestore, COLLECTIONS.NOTIFICATIONS);
export const getPaymentsCollection = () => collection(firestore, COLLECTIONS.PAYMENTS);

// Document references
export const getUserDoc = (userId: string) => doc(firestore, COLLECTIONS.USERS, userId);
export const getOrganizationDoc = (orgId: string) => doc(firestore, COLLECTIONS.ORGANIZATIONS, orgId);
export const getEventDoc = (eventId: string) => doc(firestore, COLLECTIONS.EVENTS, eventId);
export const getAttendanceDoc = (recordId: string) => doc(firestore, COLLECTIONS.ATTENDANCE, recordId);
export const getIncidentDoc = (incidentId: string) => doc(firestore, COLLECTIONS.INCIDENTS, incidentId);
export const getNotificationDoc = (notificationId: string) => doc(firestore, COLLECTIONS.NOTIFICATIONS, notificationId);
export const getPaymentDoc = (paymentId: string) => doc(firestore, COLLECTIONS.PAYMENTS, paymentId);
